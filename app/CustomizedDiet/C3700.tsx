...
const DietPlans: Record<string, MealPlan> = {
    ...
    Wed: {
        ...
        Mid_Morning: [
            ...
            { id: 89, name: 'Banana', Qt: '2', cal: '220', protein: '2', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
    ...
    Fri: {
        ...
        Mid_Morning: [
            { id: 188, name: 'Peanut Butter', Qt: '4 tbsp', cal: '360', protein: '18', image: require('@/assets/images/Chatbot/pb.jpg') },
            { id: 189, name: 'Banana', Qt: '4', cal: '430', protein: '4', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
    ...
    Sun: {
        Breakfast: [
            { id: 251, name: 'Whole Eggs', Qt: '3', cal: '225', protein: '18', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
