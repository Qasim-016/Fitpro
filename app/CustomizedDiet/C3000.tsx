...
const DietPlans: Record<string, MealPlan> = {
    Mon: {
        Breakfast: [
            ...
            { id: 54, name: 'Milk', Qt: '300ml', cal: '200', protein: '10', image: require('@/assets/images/Diet/Breakfast/milk.jpg') },
        ],
        Mid_Morning: [
    ...
    Tue: {
        Breakfast: [
            ...
            { id: 69, name: 'Banana', Qt: '4', cal: '420', protein: '4', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
    ...
    Wed: {
        ...
        Dinner: [
            { id: 16, name: 'Paneer', Qt: '250g', cal: '625', protein: '50', image: require('@/assets/images/Diet/Breakfast/pan.jpg') },
    ...
    Thu: {
        ...
        Dinner: [
            { id: 165, name: 'Grilled Fish', Qt: '150g fish', cal: '300', protein: '40', image: require('@/assets/images/Diet/Breakfast/gf.jpg') },
    ...
    Fri: {
        Breakfast: [
            { id: 184, name: 'Scrambled Eggs', Qt: '4', cal: '300', protein: '24', image: require('@/assets/images/Diet/Breakfast/ScEggs.jpg') },
            { id: 185, name: 'Cheese', Qt: '2 slice', cal: '160', protein: '10', image: require('@/assets/images/Diet/Breakfast/ch.jpg') },
        ...
        Mid_Morning: [
            { id: 188, name: 'Peanut Butter', Qt: '4 tbsp', cal: '360', protein: '16', image: require('@/assets/images/Chatbot/pb.jpg') },
            { id: 189, name: 'Banana', Qt: '3', cal: '315', protein: '3', image: require('@/assets/images/Diet/Breakfast/b.jpg') },

        ],
        Lunch: [
            { id: 24, name: 'Beef Steak', Qt: '50g', cal: '150', protein: '15', image: require('@/assets/images/Diet/Breakfast/beefs.jpg') },
    ...
    Sat: {
        ...
        Lunch: [
            ...
            { id: 275, name: 'Whole Wheat Pasta', Qt: '300g', cal: '375', protein: '12', image: require('@/assets/images/Diet/Breakfast/wpas.jpg') },
        ...
        Evening_Snack: [
            ...
            // { id: 79, name: 'Whey Protein', Qt: '30g', cal: '120', protein: '25', image: require('@/assets/images/Diet/Breakfast/wp.jpg') },
            { id: 280, name: 'Peanut Butter', Qt: '3 tbsp', cal: '270', protein: '12', image: require('@/assets/images/Chatbot/pb.jpg') },
    ...
    Sun: {
        ...
        Evening_Snack: [
            // { id: 62, name: 'Whey Protein', Qt: '1 scope', cal: '120', protein: '25', image: require('@/assets/images/Diet/Breakfast/wp.jpg') },
            { id: 263, name: 'Milk', Qt: '500ml', cal: '300', protein: '16', image: require('@/assets/images/Diet/Breakfast/milk.jpg') }
