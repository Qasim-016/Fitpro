...
const DietPlans: Record<string, MealPlan> = {
    Mon: {
        ...
        Lunch: [
            { id: 7, name: 'Chicken Breast', Qt: '50g', cal: '110', protein: '15', image: require('@/assets/images/Chatbot/bc.jpg') },
            { id: 8, name: 'Brown Rice', Qt: '1 cup', cal: '215', protein: '5', image: require('@/assets/images/Diet/Breakfast/br.jpg') },
            { id: 9, name: 'Cooked Lentils', Qt: '100g', cal: '180', protein: '12', image: require('@/assets/images/Diet/Breakfast/l.jpg') }
,            { id: 10, name: 'Mixed Vegetables', Qt: '100g', cal: '100', protein: '5', image: require('@/assets/images/Diet/Breakfast/mv.jpg') }

        ],
        Evening_Snack:[
            { id: 11, name: 'Milk', Qt: '250ml', cal: '150', protein: '8', image: require('@/assets/images/Diet/Breakfast/milk.jpg') }
,            { id: 12, name: 'Peanut Butter', Qt: '2 tbsp', cal: '180', protein: '8', image: require('@/assets/images/Chatbot/pb.jpg') }
    ...
    Tue: {
        Breakfast: [
            { id: 14, name: 'Oats', Qt: '150g', cal: '600', protein: '24', image: require('@/assets/images/Chatbot/om.jpg') },
            { id: 15, name: 'Banana', Qt: '1', cal: '105', protein: '1', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
        ...
        Dinner: [
            { id: 81, name: 'Salmon', Qt: '50g', cal: '100', protein: '14', image: require('@/assets/images/Diet/Breakfast/sal.jpg') },
    ...
    Wed: {
        ...
        Lunch: [
            { id: 106, name: 'Brown Rice', Qt: '350g', cal: '400', protein: '10', image: require('@/assets/images/Diet//Breakfast/br.jpg') },
            { id: 105, name: 'Broccoli', Qt: '100g', cal: '50', protein: '5', image: require('@/assets/images/Diet/Breakfast/bro.jpg') },
        ],
        Evening_Snack:[
...
,            { id: 34, name: 'Peanut Butter', Qt: '1 tbsp', cal: '90', protein: '4', image: require('@/assets/images/Chatbot/pb.jpg') }
    ...
    Fri: {
        ...
        Evening_Snack:[
            { id:205, name: 'Brown Rice', Qt: '200g', cal: '215', protein: '5', image: require('@/assets/images/Diet//Breakfast/br.jpg') },
            { id: 20, name: 'Almonds', Qt: '15', cal: '100', protein: '4', image: require('@/assets/images/Diet/Breakfast/alm.jpg') },
        ],
        Dinner: [
            { id: 211, name: 'Paneer', Qt: '100g', cal: '250', protein: '20', image: require('@/assets/images/Diet/Breakfast/pan.jpg') },
            { id: 121, name: 'Cooked Quinoa', Qt: '185g', cal: '220', protein: '8', image: require('@/assets/images/Diet/Breakfast/cq.jpg') },
            { id: 193, name: 'Whole Wheat Pasta', Qt: '200g', cal: '250', protein: '8', image: require('@/assets/images/Diet/Breakfast/wpas.jpg') },
    ...
    Sat: {
        Breakfast: [
            { id: 174, name: 'Oats', Qt: '150g', cal: '600', protein: '24', image: require('@/assets/images/Chatbot/om.jpg') },
            { id: 108, name: 'Almonds', Qt: '15', cal: '100', protein: '4', image: require('@/assets/images/Diet/Breakfast/alm.jpg') },
