...
const DietPlans: Record<string, MealPlan> = {
    ...
    Tue: {
        ...
        Lunch: [
            ...
            { id: 175, name: 'Sweet Potato', Qt: '200g', cal: '180', protein: '4', image: require('@/assets/images/Chatbot/sp.jpg') },
    ...
    Thu: {
        ...
        Lunch: [
            ...
            { id: 366, name: 'Sweet Potato', Qt: '220g', cal: '210', protein: '5', image: require('@/assets/images/Chatbot/sp.jpg') }
    ...
    Fri: {
        ...
        Lunch: [
            ...
            { id: 460, name: 'Grilled Chicken Breast	', Qt: '200g', cal: '330', protein: '53', image: require('@/assets/images/Chatbot/gc.jpg') },
    ...
    Sat: {
        ...
        Dinner: [
            { id: 599, name: 'Grilled Salmon', Qt: '100', cal: '210', protein: '25', image: require('@/assets/images/Diet/Breakfast/br.jpg') },
