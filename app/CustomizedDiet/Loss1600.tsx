...
const DietPlans: Record<string, MealPlan> = {
    ...
    Tue: {
        Breakfast: [
            ...
            { id: 53, name: 'Peanut Butter', Qt: '1 tbsp', cal: '90', protein: '4', image: require('@/assets/images/Chatbot/pb.jpg') },
    ...
    Wed: {
        ...
        Dinner: [
            ...
            { id: 81, name: 'Salmon', Qt: '100g', cal: '210', protein: '25', image: require('@/assets/images/Diet/Breakfast/sal.jpg') },
