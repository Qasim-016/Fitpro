...
const DietPlans: Record<string, MealPlan> = {
    ...
    Wed: {
        Breakfast: [
            ...
            { id: 152, name: 'Oats\n(skim milk)', Qt: '20g + 120ml', cal: '110', protein: '6', image: require('@/assets/images/Diet/Breakfast/omilk.jpg') },
    ...
    Sun: {
        Breakfast: [
            ...
            { id: 586, name: 'Whole Wheat Toast', Qt: '1 slice', cal: '80', protein: '3', image: require('@/assets/images/Chatbot/brownbread.jpg') },
