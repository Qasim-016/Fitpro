...
const DietPlans: Record<string, MealPlan> = {
    ...
    Wed: {
        Breakfast: [
            { id: 84, name: 'Scrambled Eggs', Qt: '7', cal: '525', protein: '42', image: require('@/assets/images/Diet/Breakfast/ScEggs.jpg') },
        ...
        Mid_Morning: [
            { id: 88, name: 'Peanut Butter', Qt: '5 tbsp', cal: '450', protein: '20', image: require('@/assets/images/Chatbot/pb.jpg') },
