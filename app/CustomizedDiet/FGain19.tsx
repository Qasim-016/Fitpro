...
const DietPlans: Record<string, MealPlan> = {
    ...
    Tue: {
        Breakfast: [
            { id: 67, name: 'Oats', Qt: '75g', cal: '300', protein: '12', image: require('@/assets/images/Chatbot/om.jpg') },
        ...
        Lunch: [
            { id: 74, name: 'Grilled Chicken Breast', Qt: '80g', cal: '180', protein: '25', image: require('@/assets/images/Chatbot/gc.jpg') },
    ...
    Wed: {
        ...
        Dinner: [
            { id: 6, name: 'Paneer', Qt: '120g', cal: '300', protein: '25', image: require('@/assets/images/Diet/Breakfast/pan.jpg') },
    ...
    Sat: {
        ...
        Lunch: [
            { id: 75, name: 'Whole Wheat Pasta', Qt: '300g', cal: '325', protein: '12', image: require('@/assets/images/Diet/Breakfast/wpas.jpg') },
    ...
    Sun: {
        ...
        Lunch: [
            { id: 58, name: 'Chicken Breast', Qt: '70g', cal: '130', protein: '20', image: require('@/assets/images/Chatbot/bc.jpg') },
            { id: 59, name: 'Brown Rice', Qt: '1 cup', cal: '215', protein: '5', image: require('@/assets/images/Diet/Breakfast/br.jpg') },
            { id: 60, name: 'Cooked Lentils', Qt: '100g', cal: '180', protein: '12', image: require('@/assets/images/Diet/Breakfast/l.jpg') }
            , { id: 61, name: 'Mixed Vegetables', Qt: '100g', cal: '100', protein: '5', image: require('@/assets/images/Diet/Breakfast/mv.jpg') }
