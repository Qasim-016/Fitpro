...
const DietPlans: Record<string, MealPlan> = {
    Mon: {
        ...
        Mid_Morning:[
            { id: 5, name: 'Almonds', Qt: '15', cal: '100', protein: '4', image: require('@/assets/images/Diet/Breakfast/alm.jpg') },
...
,            { id: 11, name: 'Peanut Butter', Qt: '1 tbsp', cal: '90', protein: '4', image: require('@/assets/images/Chatbot/pb.jpg') }
    ...
    Tue: {
        ...
        Lunch: [
            ...
            { id: 22, name: 'Olive Oil', Qt: '1 tbsp', cal: '100', protein: '0', image: require('@/assets/images/Diet/Breakfast/oil.jpg') }

        ],
        Evening_Snack:[
            { id: 23, name: 'Milk', Qt: '500ml', cal: '300', protein: '16', image: require('@/assets/images/Chatbot/gc.jpg') },
            { id: 24, name: 'Peanut Butter', Qt: '1 tbsp', cal: '90', protein: '4', image: require('@/assets/images/Chatbot/pb.jpg') },
    ...
    Wed: {
        ...
        Evening_Snack:[
            { id: 34, name: 'Almonds', Qt: '15', cal: '100', protein: '4', image: require('@/assets/images/Diet/Breakfast/alm.jpg') },
...
,            { id: 48, name: 'Peanut Butter', Qt: '1 tbsp', cal: '90', protein: '4', image: require('@/assets/images/Chatbot/pb.jpg') }
    ...
    Fri: {
        ...
        Mid_Morning:[
            ...
            { id: 55, name: 'Banana', Qt: '3', cal: '420', protein: '4', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
        ...
        Evening_Snack:[
            { id: 58, name: 'Almonds', Qt: '15', cal: '100', protein: '4', image: require('@/assets/images/Diet/Breakfast/alm.jpg') },
    ...
    Sat: {
        ...
        Evening_Snack:[
            ...
            { id: 71, name: 'Peanut Butter', Qt: '1 tbsp', cal: '90', protein: '4', image: require('@/assets/images/Chatbot/pb.jpg') },


        ],
        Dinner: [
            { id: 72, name: 'Salmon', Qt: '50g', cal: '100', protein: '14', image: require('@/assets/images/Diet/Breakfast/sal.jpg') },
...
,            { id: 86, name: 'Peanut Butter', Qt: '1 tbsp', cal: '90', protein: '4', image: require('@/assets/images/Chatbot/pb.jpg') }

        ],
        Dinner: [
            { id:87, name: 'Grilled Fish', Qt: '50g', cal: '100', protein: '14', image: require('@/assets/images/Diet/Breakfast/gf.jpg') },
