...
const DietPlans: Record<string, MealPlan> = {
    ...
    Tue: {
        ...
        Evening_Snack: [
            ...
            { id: 80, name: 'Peanut Butter', Qt: '2 tbsp', cal: '200', protein: '10', image: require('@/assets/images/Chatbot/pb.jpg') },
    ...
    Wed: {
        ...
        Dinner: [
            { id: 6, name: 'Paneer', Qt: '150g', cal: '450', protein: '30', image: require('@/assets/images/Diet/Breakfast/pan.jpg') },
    ...
    Fri: {
        Breakfast: [
            { id: 84, name: 'Scrambled Eggs', Qt: '4', cal: '300', protein: '24', image: require('@/assets/images/Diet/Breakfast/ScEggs.jpg') },
            { id: 85, name: 'Cheese', Qt: '2 slice', cal: '160', protein: '10', image: require('@/assets/images/Diet/Breakfast/ch.jpg') },
            { id: 86, name: 'Whole Wheat Toast', Qt: '2 slice', cal: '160', protein: '6', image: require('@/assets/images/Chatbot/brownbread.jpg') },
        ...
        Lunch: [
            { id: 4, name: 'Beef Steak', Qt: '50g', cal: '150', protein: '15', image: require('@/assets/images/Diet/Breakfast/beefs.jpg') },
            { id: 5, name: 'Brown Rice', Qt: '200g', cal: '215', protein: '5', image: require('@/assets/images/Diet//Breakfast/br.jpg') },
            { id: 7, name: 'Broccoli', Qt: '100g', cal: '50', protein: '5', image: require('@/assets/images/Diet/Breakfast/bro.jpg') },
        ],
        Evening_Snack: [
            { id: 70, name: 'Almonds', Qt: '15', cal: '100', protein: '4', image: require('@/assets/images/Diet/Breakfast/alm.jpg') },
            { id: 71, name: 'Protein Bar', Qt: '1', cal: '300', protein: '20', image: require('@/assets/images/Diet/Breakfast/pbar.jpg') }
        ],
        Dinner: [
            { id: 97, name: 'Cooked Quinoa', Qt: '185g', cal: '220', protein: '8', image: require('@/assets/images/Diet/Breakfast/cq.jpg') },
    ...
    Sat: {
        ...
        Lunch: [
            { id: 75, name: 'Whole Wheat Pasta', Qt: '300g', cal: '375', protein: '12', image: require('@/assets/images/Diet/Breakfast/wpas.jpg') },
        ...
        Dinner: [
            { id: 81, name: 'Salmon', Qt: '200g', cal: '400', protein: '53', image: require('@/assets/images/Diet/Breakfast/sal.jpg') },
    ...
    Sun: {
        ...
        Lunch: [
            { id: 58, name: 'Chicken Breast', Qt: '75g', cal: '170', protein: '22.5', image: require('@/assets/images/Chatbot/bc.jpg') },
            { id: 59, name: 'Brown Rice', Qt: '1 cup', cal: '215', protein: '5', image: require('@/assets/images/Diet/Breakfast/br.jpg') },
            { id: 60, name: 'Cooked Lentils', Qt: '100g', cal: '180', protein: '12', image: require('@/assets/images/Diet/Breakfast/l.jpg') }
            , { id: 61, name: 'Mixed Vegetables', Qt: '100g', cal: '100', protein: '5', image: require('@/assets/images/Diet/Breakfast/mv.jpg') }
