...
const DietPlans: Record<string, MealPlan> = {
    Mon: {
        Breakfast: [
            ...
            { id: 3, name: 'Peanut Butter', Qt: '1 tbsp', cal: '90', protein: '4', image: require('@/assets/images/Chatbot/pb.jpg') },
...
,            { id: 9, name: 'Mixed Vegetables', Qt: '100g', cal: '100', protein: '5', image: require('@/assets/images/Diet/Breakfast/mv.jpg') }
    ...
    Wed: {
        ...
        Mid_Morning:[
            ...
            { id: 31, name: 'Banana', Qt: '3', cal: '320', protein: '3', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
...
,            { id: 46, name: 'Mixed Vegetables', Qt: '100g', cal: '100', protein: '5', image: require('@/assets/images/Diet/Breakfast/mv.jpg') }
    ...
    Fri: {
        ...
        Mid_Morning:[
            ...
            { id: 55, name: 'Banana', Qt: '3', cal: '330', protein: '3', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
