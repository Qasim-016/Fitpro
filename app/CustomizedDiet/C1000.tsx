...
const DietPlans: Record<string, MealPlan> = {
    Mon: {
        ...
        Dinner: [
            { id: 57, name: 'Grilled Salmon', Qt: '50', cal: '100', protein: '12', image: require('@/assets/images/Diet/Breakfast/br.jpg') },
    ...
    Tue: {
        Breakfast: [
            { id: 60, name: 'Whole Eggs', Qt: '1', cal: '80', protein: '6', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
            { id: 61, name: 'Whole Wheat Toast', Qt: '3 slice', cal: '240', protein: '9', image: require('@/assets/images/Chatbot/brownbread.jpg') },
    ...
    Wed: {
        ...
        Lunch: [
            ...
            { id: 171, name: 'Quinoa', Qt: '50g(uncooked)', cal: '185', protein: '6.5', image: require('@/assets/images/Diet/Breakfast/uq.jpg') }
    ...
    Thu: {
        Breakfast: [
            ...
            { id: 254, name: 'Whole Wheat Toast', Qt: '2slice', cal: '160', protein: '6', image: require('@/assets/images/Chatbot/brownbread.jpg') },
            { id: 259, name: 'Almonds', Qt: '10', cal: '70', protein: '2.5', image: require('@/assets/images/Diet/Breakfast/alm.jpg') },
        ...
        Dinner: [
            ...
            { id: 25, name: 'Brown Rice', Qt: '25g', cal: '85', protein: '2', image: require('@/assets/images/Diet//Breakfast/br.jpg') },
    ...
    Fri: {
        Breakfast: [
            { id: 384, name: 'Omelet\n(eggs + spinach)', Qt: '3 + 50g', cal: '280', protein: '22', image: require('@/assets/images/Diet/Breakfast/eggspin.jpg') },
            { id: 352, name: 'Oats\n(skim milk)', Qt: '40g + 250ml', cal: '220', protein: '13', image: require('@/assets/images/Diet/Breakfast/omilk.jpg') },
            { id: 387, name: 'Milk', Qt: '125ml', cal: '75', protein: '4', image: require('@/assets/images/Diet/Breakfast/milk.jpg') },
    ...
    Sat: {
        ...
        Dinner: [
            { id: 594, name: 'Grilled Salmon', Qt: '100', cal: '210', protein: '25', image: require('@/assets/images/Diet/Breakfast/br.jpg') },
            { id: 544, name: 'Cucumber &\nTomato Salad', Qt: '100g', cal: '25', protein: '1', image: require('@/assets/images/Diet/Breakfast/ct.jpg') },
            { id: 664, name: 'Quinoa	', Qt: '25g(uncooked)', cal: '90', protein: '3', image: require('@/assets/images/Diet/Breakfast/uq.jpg') }
        ]
    ...
    Sun: {
        Breakfast: [
            { id: 551, name: 'Whole Eggs', Qt: '3', cal: '210', protein: '18', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
            { id: 586, name: 'Whole Wheat Toast', Qt: '2 slice', cal: '160', protein: '6', image: require('@/assets/images/Chatbot/brownbread.jpg') },
