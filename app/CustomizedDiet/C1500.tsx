...
const DietPlans: Record<string, MealPlan> = {
    ...
    Tue: {
        Breakfast: [
            ...
            { id: 153, name: 'Peanut Butter', Qt: '2 tbsp', cal: '180', protein: '8', image: require('@/assets/images/Chatbot/pb.jpg') },
    ...
    Fri: {
        ...
        Lunch: [
            ...
            { id: 781, name: 'Quinoa', Qt: '50g(uncooked)', cal: '185', protein: '6.5', image: require('@/assets/images/Diet/Breakfast/uq.jpg') }
    ...
    Sat: {
        ...
        Dinner: [
            { id: 559, name: 'Grilled Salmon', Qt: '100', cal: '210', protein: '25', image: require('@/assets/images/Diet/Breakfast/br.jpg') },
    ...
    Sun: {
        Breakfast: [
            ...
            { id: 653, name: 'Peanut Butter', Qt: '3 tbsp', cal: '270', protein: '12', image: require('@/assets/images/Chatbot/pb.jpg') },
        ...
        Dinner: [
            { id: 682, name: 'Chicken Stir Fry', Qt: '150g c +\n100g veg', cal: '300', protein: '50', image: require('@/assets/images/Diet/Breakfast/sfry.jpg') },
