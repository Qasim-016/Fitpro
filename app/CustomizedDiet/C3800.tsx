...
const DietPlans: Record<string, MealPlan> = {
    Mon: {
        ...
        Mid_Morning: [
            { id: 55, name: 'Banana', Qt: '1 large', cal: '120', protein: '1', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
        ...
        Dinner: [
            { id: 65, name: 'Grilled Fish', Qt: '250g fish', cal: '500', protein: '65', image: require('@/assets/images/Diet/Breakfast/gf.jpg') },
    ...
    Tue: {
        ...
        Dinner: [
            { id: 81, name: 'Salmon', Qt: '250g', cal: '500', protein: '65', image: require('@/assets/images/Diet/Breakfast/sal.jpg') },
    ...
    Wed: {
        ...
        Mid_Morning: [
            ...
            { id: 89, name: 'Banana', Qt: '1', cal: '120', protein: '1', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
        ...
        Dinner: [
            { id: 16, name: 'Paneer', Qt: '300g', cal: '750', protein: '60', image: require('@/assets/images/Diet/Breakfast/pan.jpg') },
    ...
    Thu: {
        Breakfast: [
            { id: 151, name: 'Whole Eggs', Qt: '4', cal: '300', protein: '24', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
        ...
        Mid_Morning: [
            { id: 155, name: 'Banana', Qt: '1', cal: '100', protein: '1', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
        ...
        Dinner: [
            ...
            { id: 101, name: 'Whole Eggs', Qt: '2', cal: '150', protein: '12', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
    ...
    Fri: {
        ...
        Mid_Morning: [
            ...
            { id: 189, name: 'Banana', Qt: '4', cal: '420', protein: '4', image: require('@/assets/images/Diet/Breakfast/b.jpg') },

        ],
        Lunch: [
            { id: 24, name: 'Beef Steak', Qt: '200g', cal: '440', protein: '50', image: require('@/assets/images/Diet/Breakfast/beefs.jpg') },
        ...
        Dinner: [
            { id: 26, name: 'Paneer', Qt: '250g', cal: '625', protein: '50', image: require('@/assets/images/Diet/Breakfast/pan.jpg') },
    ...
    Sat: {
        ...
        Lunch: [
            ...
            { id: 276, name: 'Olive Oil', Qt: '2 tbsp', cal: '200', protein: '0', image: require('@/assets/images/Diet/Breakfast/oil.jpg') }
    ...
    Sun: {
        ...
        Mid_Morning: [
            { id: 990, name: 'Banana', Qt: '2', cal: '210', protein: '2', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
            // { id: 56, name: 'Almonds', Qt: '15', cal: '100', protein: '4', image: require('@/assets/images/Diet/Breakfast/alm.jpg') },
            { id: 255, name: 'Whole Eggs', Qt: '3', cal: '225', protein: '18', image: require('@/assets/images/Diet/Breakfast/e.jpg') },

            { id: 257, name: 'Yogurt', Qt: '2 bowl', cal: '300', protein: '20', image: require('@/assets/images/Diet/Breakfast/y.jpg') },
        ],
        Lunch: [
            { id: 58, name: 'Chicken Breast', Qt: '100g', cal: '220', protein: '30', image: require('@/assets/images/Chatbot/bc.jpg') },
            ...
            , { id: 261, name: 'Mixed Vegetables', Qt: '50g', cal: '50', protein: '2', image: require('@/assets/images/Diet/Breakfast/mv.jpg') }
        ...
        Dinner: [
            { id: 65, name: 'Grilled Fish', Qt: '300g fish', cal: '600', protein: '77', image: require('@/assets/images/Diet/Breakfast/gf.jpg') },
