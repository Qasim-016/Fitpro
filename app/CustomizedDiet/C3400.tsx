...
const DietPlans: Record<string, MealPlan> = {
    ...
    Wed: {
        ...
        Mid_Morning: [
            ...
            { id: 89, name: 'Banana', Qt: '2', cal: '210', protein: '2', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
    ...
    Thu: {
        ...
        Evening_Snack: [
            { id: 162, name: 'Whey Protein', Qt: '2 scope', cal: '240', protein: '50', image: require('@/assets/images/Diet/Breakfast/wp.jpg') },
    ...
    Fri: {
        Breakfast: [
            { id: 184, name: 'Scrambled Eggs', Qt: '6', cal: '450', protein: '36', image: require('@/assets/images/Diet/Breakfast/ScEggs.jpg') },
