...
const DietPlans: Record<string, MealPlan> = {
    Mon: {
        Breakfast: [
            { id: 51, name: 'Whole Eggs', Qt: '2Eggs', cal: '170', protein: '12', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
        ...
        Dinner: [
            ...
            { id: 66, name: 'Quinoa	', Qt: '25g(uncooked)', cal: '90', protein: '3', image: require('@/assets/images/Diet/Breakfast/uq.jpg') }
        ]

    },
    Tue: {
        Breakfast: [
            { id: 51, name: 'Whole Eggs', Qt: '1', cal: '80', protein: '6', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
    ...
    Wed: {
        ...
        Dinner: [
            { id: 5, name: 'Brown Rice', Qt: '25g(uncooked)', cal: '85', protein: '2', image: require('@/assets/images/Diet//Breakfast/br.jpg') },
            { id: 81, name: 'Salmon', Qt: '50g', cal: '100', protein: '13', image: require('@/assets/images/Diet/Breakfast/sal.jpg') },
    ...
    Thu: {
        ...
        Dinner: [
            ...
            { id: 5, name: 'Brown Rice', Qt: '25g', cal: '85', protein: '2', image: require('@/assets/images/Diet//Breakfast/br.jpg') },
    ...
    Fri: {
        Breakfast: [
            { id: 84, name: 'Omelet\n(eggs + spinach)', Qt: '3 + 50g', cal: '280', protein: '22', image: require('@/assets/images/Diet/Breakfast/eggspin.jpg') },
            { id: 52, name: 'Oats\n(skim milk)', Qt: '40g + 250ml', cal: '220', protein: '13', image: require('@/assets/images/Diet/Breakfast/omilk.jpg') },
            { id: 87, name: 'Milk', Qt: '125ml', cal: '75', protein: '4', image: require('@/assets/images/Diet/Breakfast/milk.jpg') },
    ...
    Sat: {
        ...
        Breakfast: [
            { id: 51, name: 'Whole Eggs\n(Olive oil)', Qt: '2Eggs 1tbsp oil', cal: '220', protein: '15', image: require('@/assets/images/Diet/Breakfast/eo.jpg') },
            { id: 52, name: 'Oats\n(skim milk)', Qt: '40g + 250ml', cal: '220', protein: '13', image: require('@/assets/images/Chatbot/brownbread.jpg') },
        ],
        ...
        Dinner: [
            { id: 59, name: 'Grilled Salmon', Qt: '100', cal: '210', protein: '25', image: require('@/assets/images/Diet/Breakfast/br.jpg') },
            { id: 54, name: 'Cucumber &\nTomato Salad', Qt: '100g', cal: '25', protein: '1', image: require('@/assets/images/Diet/Breakfast/ct.jpg') },
            { id: 66, name: 'Quinoa	', Qt: '25g(uncooked)', cal: '90', protein: '3', image: require('@/assets/images/Diet/Breakfast/uq.jpg') }
        ]
    ...
    Sun: {
        Breakfast: [
            { id: 51, name: 'Whole Eggs', Qt: '3', cal: '210', protein: '18', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
            { id: 86, name: 'Whole Wheat Toast', Qt: '2 slice', cal: '160', protein: '6', image: require('@/assets/images/Chatbot/brownbread.jpg') },
