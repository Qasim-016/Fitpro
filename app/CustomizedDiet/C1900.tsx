...
const DietPlans: Record<string, MealPlan> = {
    Mon: {
        ...
        Dinner: [
            { id: 69, name: 'Grilled Salmon', Qt: '200', cal: '410', protein: '48', image: require('@/assets/images/Diet/Breakfast/br.jpg') },
    ...
    Tue: {
        ...
        Dinner: [
            { id: 182, name: 'Chicken Stir Fry', Qt: '200g c +\n120g veg', cal: '400', protein: '60', image: require('@/assets/images/Diet/Breakfast/sfry.jpg') },
            { id: 183, name: 'Brown Rice', Qt: '100g(uncooked)', cal: '350', protein: '8', image: require('@/assets/images/Diet/Breakfast/ur.jpg') }
    ...
    Wed: {
        ...
        Lunch: [
            ...
            { id: 260, name: 'Grilled Chicken Breast	', Qt: '250g', cal: '410', protein: '65', image: require('@/assets/images/Chatbot/gc.jpg') },
    ...
    Thu: {
        ...
        Lunch: [
            ...
            { id: 366, name: 'Sweet Potato', Qt: '200g', cal: '180', protein: '4', image: require('@/assets/images/Chatbot/sp.jpg') }
        ...
        Dinner: [
            ...
            { id: 35, name: 'Brown Rice', Qt: '60g', cal: '225', protein: '5', image: require('@/assets/images/Diet//Breakfast/br.jpg') },
    ...
    Fri: {
        ...
        Lunch: [
            ...
            { id: 751, name: 'Quinoa', Qt: '50g(uncooked)', cal: '185', protein: '6.5', image: require('@/assets/images/Diet/Breakfast/uq.jpg') }

        ],

        Dinner: [
            { id: 45, name: 'Brown Rice', Qt: '50g(uncooked)', cal: '175', protein: '4', image: require('@/assets/images/Diet//Breakfast/br.jpg') },
            { id: 481, name: 'Salmon', Qt: '200g', cal: '410', protein: '48', image: require('@/assets/images/Diet/Breakfast/sal.jpg') },
    ...
    Sat: {
        ...
        Dinner: [
            { id: 569, name: 'Grilled Salmon', Qt: '150', cal: '310', protein: '37', image: require('@/assets/images/Diet/Breakfast/br.jpg') },
    ...
    Sun: {
        Breakfast: [
            ...
            { id: 653, name: 'Peanut Butter', Qt: '4 tbsp', cal: '360', protein: '16', image: require('@/assets/images/Chatbot/pb.jpg') },

        ],

        Lunch: [
            { id: 674, name: 'Grilled Fish', Qt: '200g', cal: '270', protein: '60', image: require('@/assets/images/Diet/Breakfast/gf.jpg') },
        ...
        Dinner: [
            ...
            { id: 683, name: 'Brown Rice', Qt: '100g(uncooked)', cal: '350', protein: '8', image: require('@/assets/images/Diet/Breakfast/ur.jpg') }
