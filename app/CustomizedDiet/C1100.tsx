...
const DietPlans: Record<string, MealPlan> = {
    Mon: {
        ...
        Dinner: [
            { id: 598, name: 'Grilled Salmon', Qt: '50', cal: '100', protein: '12', image: require('@/assets/images/Diet/Breakfast/br.jpg') },
    ...
    Tue: {
        Breakfast: [
            { id: 531, name: 'Whole Eggs', Qt: '2', cal: '150', protein: '12', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
            { id: 86, name: 'Whole Wheat Toast', Qt: '2 slice', cal: '160', protein: '6', image: require('@/assets/images/Chatbot/brownbread.jpg') },

        ],

        Lunch: [
            { id: 174, name: 'Grilled Fish', Qt: '150g', cal: '200', protein: '45', image: require('@/assets/images/Diet/Breakfast/gf.jpg') },
            { id: 175, name: 'Sweet Potato', Qt: '100g', cal: '90', protein: '2', image: require('@/assets/images/Chatbot/sp.jpg') },
    ...
    Wed: {
        ...
        Lunch: [
            ...
            { id: 731, name: 'Quinoa', Qt: '50g(uncooked)', cal: '185', protein: '6.5', image: require('@/assets/images/Diet/Breakfast/uq.jpg') }
    ...
    Fri: {
        ...
        Lunch: [
            ...
            { id: 751, name: 'Quinoa', Qt: '20g(uncooked)', cal: '85', protein: '2.5', image: require('@/assets/images/Diet/Breakfast/uq.jpg') }

        ],

        Dinner: [
            { id: 544, name: 'Brown Rice', Qt: '50g(uncooked)', cal: '175', protein: '4', image: require('@/assets/images/Diet//Breakfast/br.jpg') },
    ...
    Sat: {
        ...
        Dinner: [
            { id: 595, name: 'Grilled Salmon', Qt: '100', cal: '210', protein: '25', image: require('@/assets/images/Diet/Breakfast/br.jpg') },
            { id: 554, name: 'Cucumber &\nTomato Salad', Qt: '100g', cal: '25', protein: '1', image: require('@/assets/images/Diet/Breakfast/ct.jpg') },
            { id: 666, name: 'Quinoa	', Qt: '50g(uncooked)', cal: '185', protein: '6.5', image: require('@/assets/images/Diet/Breakfast/uq.jpg') }
        ]
    ...
    Sun: {
        Breakfast: [
            { id: 516, name: 'Whole Eggs', Qt: '3', cal: '210', protein: '18', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
            { id: 865, name: 'Whole Wheat Toast', Qt: '2 slice', cal: '160', protein: '6', image: require('@/assets/images/Chatbot/brownbread.jpg') },

        ],

        Lunch: [
            { id: 742, name: 'Grilled Fish', Qt: '150g', cal: '200', protein: '45', image: require('@/assets/images/Diet/Breakfast/gf.jpg') },
            { id: 752, name: 'Sweet Potato', Qt: '200g', cal: '180', protein: '4', image: require('@/assets/images/Chatbot/sp.jpg') },
            { id: 763, name: 'Steamed Spinach', Qt: '100g', cal: '25', protein: '3', image: require('@/assets/images/Diet/Breakfast/spin.jpg') }

        ],

        Dinner: [
            { id: 823, name: 'Chicken Stir Fry', Qt: '100g c +\n100g veg', cal: '200', protein: '40', image: require('@/assets/images/Diet/Breakfast/sfry.jpg') },
            { id: 833, name: 'Brown Rice', Qt: '50g(uncooked)', cal: '175', protein: '4', image: require('@/assets/images/Diet/Breakfast/ur.jpg') }
