...
const DietPlans: Record<string, MealPlan> = {
    ...
    Tue: {
        ...
        Dinner: [
            ...
            { id: 83, name: 'Mashed Potatoes', Qt: '100g', cal: '100', protein: '3.5', image: require('@/assets/images/Diet/Breakfast/mp.jpg') }
    ...
    Wed: {
        Breakfast: [
            { id: 84, name: 'Scrambled Eggs', Qt: '5', cal: '375', protein: '30', image: require('@/assets/images/Diet/Breakfast/ScEggs.jpg') },
    ...
    Thu: {
        ...
        Lunch: [
            { id: 58, name: 'Chicken Breast', Qt: '150g', cal: '340', protein: '45', image: require('@/assets/images/Chatbot/bc.jpg') },
    ...
    Sat: {
        ...
        Mid_Morning: [
            { id: 272, name: 'Boiled Eggs', Qt: '1', cal: '75', protein: '6', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
    ...
    Sun: {
        ...
        Dinner: [
            { id: 65, name: 'Grilled Fish', Qt: '400g fish', cal: '800', protein: '100', image: require('@/assets/images/Diet/Breakfast/gf.jpg') },
