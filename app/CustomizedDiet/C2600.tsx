...
const DietPlans: Record<string, MealPlan> = {
    Mon: {
        ...
        Mid_Morning: [
            { id: 55, name: 'Banana', Qt: '1', cal: '105', protein: '1', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
    ...
    Tue: {
        Breakfast: [
            { id: 67, name: 'Oats', Qt: '100g', cal: '400', protein: '16', image: require('@/assets/images/Chatbot/om.jpg') },
        ...
        Evening_Snack: [
            { id: 78, name: 'Milk', Qt: '500ml', cal: '300', protein: '16', image: require('@/assets/images/Chatbot/gc.jpg') },
    ...
    Wed: {
        ...
        Lunch: [
            { id: 15, name: 'Brown Rice', Qt: '200g', cal: '215', protein: '5', image: require('@/assets/images/Diet//Breakfast/br.jpg') },
        ...
        Evening_Snack: [
            ...
            { id: 171, name: 'Protein Bar', Qt: '1', cal: '250', protein: '20', image: require('@/assets/images/Diet/Breakfast/pbar.jpg') }
        ],
        Dinner: [
    ...
    Thu: {
        ...
        Mid_Morning: [
            { id: 155, name: 'Banana', Qt: '1', cal: '105', protein: '1', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
        ...
        Evening_Snack: [
            ...
            { id: 163, name: 'Milk', Qt: '250ml', cal: '150', protein: '8', image: require('@/assets/images/Diet/Breakfast/milk.jpg') }
    ...
    Fri: {
        ...
        Mid_Morning: [
            { id: 188, name: 'Peanut Butter', Qt: '1 tbsp', cal: '90', protein: '4', image: require('@/assets/images/Chatbot/pb.jpg') },
            { id: 189, name: 'Banana', Qt: '3', cal: '420', protein: '4', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
        ...
        Evening_Snack: [
            ...
            { id: 271, name: 'Protein Bar', Qt: '1', cal: '250', protein: '20', image: require('@/assets/images/Diet/Breakfast/pbar.jpg') }
        ],
        Dinner: [
            { id: 26, name: 'Paneer', Qt: '200g', cal: '500', protein: '40', image: require('@/assets/images/Diet/Breakfast/pan.jpg') },
    ...
    Sat: {
        Breakfast: [
            ...
            { id: 269, name: 'Banana', Qt: '2', cal: '210', protein: '2', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
            { id: 370, name: 'Almonds', Qt: '15', cal: '100', protein: '4', image: require('@/assets/images/Diet/Breakfast/alm.jpg') },
            { id: 471, name: 'Milk', Qt: '250ml', cal: '150', protein: '8', image: require('@/assets/images/Diet/Breakfast/milk.jpg') }
        ...
        Evening_Snack: [
            { id: 278, name: 'Milk', Qt: '250ml', cal: '150', protein: '8', image: require('@/assets/images/Chatbot/gc.jpg') },
            { id: 280, name: 'Peanut Butter', Qt: '1 tbsp', cal: '90', protein: '4', image: require('@/assets/images/Chatbot/pb.jpg') },


        ],
        Dinner: [
            { id: 281, name: 'Salmon', Qt: '150g', cal: '300', protein: '40', image: require('@/assets/images/Diet/Breakfast/sal.jpg') },
            { id: 282, name: 'Steamed Vegetables', Qt: '100g', cal: '100', protein: '5', image: require('@/assets/images/Diet/Breakfast/sv.jpg') },
            { id: 283, name: 'Mashed Potatoes', Qt: '200g', cal: '200', protein: '5', image: require('@/assets/images/Diet/Breakfast/mp.jpg') }
    ...
    Sun: {
        Breakfast: [
            { id: 251, name: 'Whole Eggs', Qt: '2', cal: '150', protein: '12', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
            { id: 252, name: 'Whole Wheat Bread', Qt: '2', cal: '160', protein: '6', image: require('@/assets/images/Chatbot/brownbread.jpg') },
            { id: 253, name: 'Peanut Butter', Qt: '2 tbsp', cal: '190', protein: '8', image: require('@/assets/images/Chatbot/pb.jpg') },
        ...
        Evening_Snack: [
            ...
            , { id: 264, name: 'Peanut Butter', Qt: '1 tbsp', cal: '90', protein: '4', image: require('@/assets/images/Chatbot/pb.jpg') }

        ],
        Dinner: [
            { id: 265, name: 'Grilled Fish', Qt: '150g fish', cal: '300', protein: '40', image: require('@/assets/images/Diet/Breakfast/gf.jpg') },
