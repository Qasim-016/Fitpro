...
const DietPlans: Record<string, MealPlan> = {
    ...
    Tue: {
        Breakfast: [
            { id: 67, name: 'Oats', Qt: '200g', cal: '800', protein: '32', image: require('@/assets/images/Chatbot/om.jpg') },
    ...
    Wed: {
        ...
        Dinner: [
            { id: 16, name: 'Paneer', Qt: '400g', cal: '1000', protein: '80', image: require('@/assets/images/Diet/Breakfast/pan.jpg') },
    ...
    Sun: {
        ...
        Dinner: [
            { id: 65, name: 'Grilled Fish', Qt: '200g fish', cal: '400', protein: '50', image: require('@/assets/images/Diet/Breakfast/gf.jpg') },
