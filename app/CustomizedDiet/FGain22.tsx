...
const DietPlans: Record<string, MealPlan> = {
    Mon: {
        ...
        Lunch: [
            { id: 58, name: 'Chicken Breast', Qt: '80g', cal: '170', protein: '22', image: require('@/assets/images/Chatbot/bc.jpg') },
...
,            { id: 64, name: 'Peanut Butter', Qt: '3 tbsp', cal: '270', protein: '12', image: require('@/assets/images/Chatbot/pb.jpg') }
    ...
    Wed: {
        ...
        Dinner: [
            { id: 6, name: 'Paneer', Qt: '130g', cal: '330', protein: '25', image: require('@/assets/images/Diet/Breakfast/pan.jpg') },
    ...
    Thu: {
        Breakfast: [
            ...
            { id: 54, name: 'Milk', Qt: '400ml', cal: '250', protein: '12', image: require('@/assets/images/Diet/Breakfast/milk.jpg') },
        ],
        Mid_Morning:[
...
,            { id: 64, name: 'Peanut Butter', Qt: '1 tbsp', cal: '90', protein: '4', image: require('@/assets/images/Chatbot/pb.jpg') }
    ...
    Sat: {
        ...
        Evening_Snack:[
            ...
            { id: 90, name: 'Boiled Eggs', Qt: '3', cal: '225', protein: '6', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
    ...
    Sun: {
        ...
        Mid_Morning:[
            { id: 90, name: 'Banana', Qt: '2', cal: '210', protein: '2', image: require('@/assets/images/Diet/Breakfast/b.jpg') },
            { id: 55, name: 'Whole Eggs', Qt: '1', cal: '75', protein: '6', image: require('@/assets/images/Diet/Breakfast/e.jpg') },
