...
const Chatbot = () => {
  ...
  const handleSubmitQuestion = async () => {
    if (userQuestion.trim() && userId) {
      ...
      try {
        const response = await axios.post('http://192.168.0.109:5000/api/chatbot', { question: userQuestion });
...
//       try {
//         const response = await axios.post('http://192.168.0.109:5000/api/chat', {
//           userId,
...
//       try {
//         console.log('Sending question to bot:', userQuestion); // Log the user question being sent
//         const response = await axios.post('https://webhook.botpress.cloud/afb3a350-fa84-432d-bc9f-969c2450865d', {
//           userId,
//           question: userQuestion,
//         });
  
//         console.log('Response from bot:', JSON.stringify(response.data, null, 2)); // Log the full response
  
//         // Safely check if the response contains the expected structure
//         const botResponse = response?.data?.data?.messages?.[0]?.text || 'No response from bot';
  
//         if (botResponse !== 'No response from bot') {
//           console.log('Bot Reply:', botResponse); // Log the bot's reply
//           updatedChatHistory = [
//             ...updatedChatHistory,
//             {
//               sender: 'bot',
...
//           await AsyncStorage.setItem(key, JSON.stringify(updatedChatHistory));
//         } else {
//           console.warn('No valid reply from bot. Response structure may be incorrect.');
//         }
//       } catch (error) {
//         console.error('Error fetching bot response:', error); // Log errors
//       }
//     } else {
//       console.warn('User question is empty or userId is missing.');
//     }
//   };
...
//       ) : (
//         <WebView
//           source={{ uri: 'https://cdn.botpress.cloud/webchat/v2.2/shareable.html?configUrl=https://files.bpcontent.cloud/2024/12/06/14/20241206144040-BHCK4FPV.json' }} // Replace with your chatbot URL
//           style={{ flex: 1 }}
//         />
//       )}
//     </SafeAreaView>
