...
const handleSignup = async () => {
  ...
  if (validateForm()) {
    try {
      ...
      const response = await axios.post('http://192.168.0.115:5000/api/auth/signup', {
  ...
  const handleEmailVerification = async (uid:string) => {
    try {
      const response = await axios.post('http://192.168.0.115:5000/api/auth/verifyUserEmail', { uid });
